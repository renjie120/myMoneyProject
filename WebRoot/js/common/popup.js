...
//    popObj.style.top = arrayPageScroll[1] + (arrayPageSize[3] - arrayConSize[1]) / 2 - 0 + 'px';
    popObj.style.top = (arrayPageSize[3] - arrayConSize[1]) / 2 - 0 + 'px';
    popObj.style.left = (arrayPageSize[0] - arrayConSize[0]) / 2 - 0 + 'px';
}
//获取内容层内容原始尺寸
...
//    arrayPageSize = new Array(pageWidth, pageHeight, windowWidth, windowHeight);
    arrayPageSize = new Array(windowWidth, windowHeight, windowWidth, windowHeight);
